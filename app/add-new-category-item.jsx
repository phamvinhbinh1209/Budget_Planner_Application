import { View, Text, Image, StyleSheet, TextInput, ScrollView, KeyboardAvoidingView, ActivityIndicator } from 'react-native'
...
export default function AddNewCategoryItem() {
    ...
    const onClickAdd = async() => {
        ...
        if (data) {
            const fileUrl = "https://kuolpepncedbnirbajxp.supabase.co/storage/v1/object/public/images/" + fileName + ".png";
            console.log(fileUrl);
